...
public class StockQuote
{
     ...
     */
    private static String getSOAPQuote(String symbol)
    {
        String response = "";
     ...
     * @throws IOException
     */
    private static void writeRequest(String message, HttpURLConnection httpConn) throws IOException
    {
     ...
     */
    private static HttpURLConnection setUpHttpConnection(URL url, int length) throws IOException,
        ProtocolException
    {
     ...
     */
    private static String createMessage(String symbol)
    {
