...
public class Utils {
	...
	public static String getWebPageContents(DefaultHttpClient httpclient,
			String URL) throws Exception {
		return httpclient.execute(new HttpGet(URL), new BasicResponseHandler());
	}

	public static void guruFocusLogin(DefaultHttpClient httpclient,
